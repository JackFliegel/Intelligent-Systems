...
def runFeedForward():
    ...
    layer1Case1 = Layer(784, 250, load_pretrained_weights('./HW5_datafiles/finalInputs.txt'))# 784 'features' and 250 output to hidden layer, load weights
    ...
    layer1Case2 = Layer(784, 250, load_pretrained_weights('./HW5_datafiles/finalInputs.txt'))# 784 'features' and 250 output to hidden layer, load weights
